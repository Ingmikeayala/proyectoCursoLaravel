                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('proyectos.destroy',$proyecto->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('proyectos.show',$proyecto->id) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Mostar') }}</a>
                                                    <a class="btn btn-sm btn-info" href="{{ route('pdf.reporte',$proyecto->id) }}">pdf</a>
